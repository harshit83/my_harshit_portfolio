...
export default function About() {
  ...
  return (
    <div id="about" className="w-[90%] select-none mx-auto text-white pt-[8vh]">
      ...
      <h1 data-aos="zoom-in" data-aos-duration="400" className="text-center  text-[5vh] font-semibold mb-[2vh]">
        About Me
      </h1>
      
      <h2 data-aos="fade-up" data-aos-duration="400" className="mb-[5vh] text-[2.4vh] mx-auto md:text-[3vh] w-fit px-[2vh] text-cyan-900 bg-cyan-300">
        Full Stack Developer
      </h2>

      <div className="flex flex-col-reverse md:flex-row md:w-[95%] mx-auto justify-between">
        <div data-aos="fade-left" data-aos-duration="1000" className="w-[90%] md:w-[60%] mx-auto md:mx-0">
        ...
        <Tilt  className="mx-auto md:mx-0 ">
          <div data-aos="fade-right" data-aos-duration="1000" className="gauravimg relative p-[1vh] w-[80vw] h-[52vh] md:w-[50vh] md:h-[60vh] flex flex-row justify-center items-center">
            <img

...
export default function HomeSection() {
  ...
  return (
    <div id="home" className="w-[90%] mx-auto home overflow-hidden">
      <div
        data-aos="zoom-in"
        data-aos-duration="2000"
        className="svglb absolute"
      >
      ...
      <div>
        <Lottie
          animationData={lines}
          className="lines absolute opacity-50 top-[40%] left-0 -z-50"
        />
      </div>
      <div>
        <Lottie
          animationData={lines}
          className="lines absolute opacity-50 top-[40%] right-0 rotate-180 -z-50"
        />
      </div>
    </div>
  );
